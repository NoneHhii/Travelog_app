      ...
      >
        ...
        <TouchableOpacity style={styles.cardLink} activeOpacity={0.8}>
          <View style={styles.cardContentLeft}>
            <Text style={styles.cardLinkText}>Xem tất cả sản phẩm đã lưu</Text>
            <Ionicons
              name="arrow-forward"
              size={18}
              color={themeColor}
          ...
          <View style={styles.gridPreview}>
            <View
              style={[
                styles.gridLargeBox,
                { backgroundColor: previewBox1Color },
              ]}
            />
            <View style={styles.gridSmallColumn}>
              <View
                style={[
                  styles.gridSmallBox,
                  { backgroundColor: previewBox2Color },
                ]}
              />
              <View
                style={[
                  styles.gridSmallBox,
                  { backgroundColor: previewBox3Color },
                ]}
              />
            </View>
          </View>
        ...
        <View style={styles.card}>
          <View style={styles.collectionHeader}>
            <View
              style={[
                styles.collectionIconWrapper,
                { backgroundColor: collectionIconBackgroundColor },
              ]}
            >
              <Ionicons
                name="bookmarks"
            ...
            <View style={styles.collectionTextGroup}>
              ...
              <Text style={styles.collectionSubtitle}>
                Tạo danh sách yêu thích và lên kế hoạch dễ dàng khi sắp xếp các
                sản phẩm đã lưu với Bộ sưu tập!
              </Text>
            </View>
          </View>
          <TouchableOpacity style={styles.createCollectionLink}>
            {/* Link màu xanh dương */}
            <Text style={[styles.createCollectionText, { color: linkColor }]}>
              Tạo bộ sưu tập mới
            </Text>
          </TouchableOpacity>
        </View>
